...
/**
 * The implementation of {@link org.snappier.camera.utils.OrientationManager}
...
public class OrientationManagerImpl implements OrientationManager {
    ...
    public DeviceNaturalOrientation getDeviceNaturalOrientation() {
        return DeviceNaturalOrientation.PORTRAIT;
    }
    ...
    public DeviceOrientation getDisplayRotation() {
        return DeviceOrientation.from(
                (360 - getDisplayRotation(mActivity)) % 360);
    }
